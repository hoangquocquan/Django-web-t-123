...
LEGACY_API_ROUTES = [
    ...
    },
    {
        ...
        "django_replacement": "/api/v1/news/",
        "replacement_ready": True,
        "notes": "Django news replacement is CMS-backed.",
    },
    {
        "method": "GET",
        "legacy_path": "/api/home",
        "django_replacement": "/api/v1/public/home/",
        "replacement_ready": True,
        "notes": "Django home aggregate replacement exists.",
    },
    {
        "method": "GET",
        "legacy_path": "/api/capabilities",
        "django_replacement": "/api/v1/catalog/capabilities/",
        "replacement_ready": True,
        "notes": "Django capabilities replacement exists.",
    },
    {
        "method": "GET",
        "legacy_path": "/api/openapi.json",
        "django_replacement": "/api/v1/openapi.json",
        "replacement_ready": True,
        "notes": "Django compact OpenAPI replacement exists.",
    },
    {
        "method": "GET",
        "legacy_path": "/api/version",
        "django_replacement": "/api/v1/version/",
        "replacement_ready": True,
        "notes": "Django version replacement exists.",
    },
    {
        "method": "GET",
        "legacy_path": "/api/aws-demo",
        "django_replacement": "/api/v1/demo/aws/",
        "replacement_ready": True,
        "notes": "Django AWS demo replacement exists.",
    },
    {
        "method": "GET",
        "legacy_path": "/api/external/weather",
        "django_replacement": "/api/v1/demo/external/weather/",
        "replacement_ready": True,
        "notes": "Django weather demo replacement exists.",
    },
    {
        "method": "POST",
        ...
        "replacement_ready": True,
        "notes": "Django validates and accepts contact write intents.",
    },
    {
        "method": "POST",
        ...
        "replacement_ready": True,
        "notes": "Django validates and accepts quote write intents.",
    },
    {
        "method": "POST",
        "legacy_path": "/api/ai/chat",
        "django_replacement": "/api/v1/ai/chat/",
        "replacement_ready": True,
        "notes": "Django migration-safe AI chat replacement exists.",
    },
    {
        ...
        "django_replacement": "/api/v1/catalog/products/",
        "replacement_ready": True,
        "notes": "Django validates protected product write intents.",
    },
]
